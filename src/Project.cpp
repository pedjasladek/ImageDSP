	...
	while(!xml.atEnd()) {
		...
		if(xml.isStartElement()){
			if(xml.name() == "program"){
				...
				r2[0] = file_name;
				//TODO Nicer.
                QString full_file_name = QString("/home/niketic95/Documents/University/VI/OAiSDSP2/PROJECT/in_img/") + file_name;
				...
				r2[0] = file_name;
				//TODO Nicer.
                QString full_file_name = QString("/Documents/University/VI/OAiSDSP2/PROJECT/out_img/") + file_name;
